...
from ks_mini.data.read_file_yaml import GetDataYaml
from ks_mini.request_send.user_account import UserAccount, UserAccountLoginOUt, UserAccountChangePassword
import allure
import pytest
...
class TestLogin:
    ...
    def test_login(login_data):
        # @allure.step("获取用例数据")
        login_path = GetDataYaml.read_file_yaml('/data/login.yaml')
    ...
    # def test_change_pwd(self):
        change_password_path = GetDataYaml.read_file_yaml('/data/change_password.yaml')
